...
- (void)didReceivePoseChange:(NSNotification *)notification {
    ...
    switch (pose.type) {
        ...
        case TLMPoseTypeRest:
            [self postColorToOctoblu:@"white" forBulb:@1];
        ...
        case TLMPoseTypeFist:
            ...
            [self postColorToOctoblu:@"purple" forBulb:@1];
            break;
        case TLMPoseTypeWaveIn:
            ...
            self.helloLabel.textColor = [UIColor greenColor];
            [self postColorToOctoblu:@"red" forBulb:@1];
            break;
        case TLMPoseTypeWaveOut:
            ...
            self.helloLabel.textColor = [UIColor greenColor];
            [self postColorToOctoblu:@"green" forBulb:@1];
            break;
        case TLMPoseTypeFingersSpread:
            ...
            self.helloLabel.textColor = [UIColor greenColor];
            [self postColorToOctoblu:@"blue" forBulb:@1];
            break;
    }
//
...
- (void)postColorToOctoblu:(NSString *)color forBulb:(NSNumber *)bulbNumber {
    
    if([color isEqualToString:@"white"]){return;}
    
    NSString *post = [NSString stringWithFormat:@"color=%@&light=%@", color , [bulbNumber stringValue]];
